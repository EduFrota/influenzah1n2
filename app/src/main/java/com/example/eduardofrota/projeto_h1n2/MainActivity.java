...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_sobre) {
            Intent i  = new Intent(MainActivity.this, sobreH1N2.class);
            startActivity(i);
            // Handle the camera action
        } else if (id == R.id.nav_tratamento) {
            Intent i  = new Intent(MainActivity.this, ActivityTratamento.class);
            startActivity(i);
            ...
            Intent i  = new Intent(MainActivity.this, ActivityReferencias.class);
            startActivity(i);
